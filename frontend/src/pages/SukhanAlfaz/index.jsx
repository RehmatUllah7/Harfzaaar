...
const feedbacks = {
  ...
  score60plus: [
    "کیا بات ہے! تینوں الفاظ کا جادو چل گیا۔",
    "آپ کی شاعری نے دل چھو لیا۔",
    "الفاظ کا بہترین استعمال، شاباش!",
    "شاعری میں گہرائی ہے، واہ!",
    "کیا خوبصورت انداز میں تینوں الفاظ باندھے ہیں۔",
    "کمال شاعری! روح کو چھو گئی۔",
    "آپ واقعی شاعر دلنواز ہیں۔",
    "تینوں الفاظ، اور وہ بھی خوبصورتی سے!",
    "دل کو بہا لے گئی آپ کی تخلیق۔",
    "یہی ہے اصل فنکاری!"
  ]
};
